...
# Repositories
repo --name=base --baseurl=http://mirror.centos.org/centos/5/os/x86_64
...
# repo --name=cloud-init --baseurl=http://repos.fedorapeople.org/repos/openstack/cloud-init/epel-5/
...
part / --size 100 --fstype ext3 --grow
...
sed -i 's/^user: ec2-user/user: gc3-user/g' /etc/cloud/cloud.cfg
...
# 
# # Disabled because dracut is not present in CentOS-5
